...
public class AnimationInterpolator implements Interpolator {
    ...
    public AnimationInterpolator(PointF start, PointF end) throws IllegalArgumentException {
    ...
    public AnimationInterpolator(float startX, float startY, float endX, float endY) {
        this(new PointF(startX, startY), new PointF(endX, endY));
    }

    public AnimationInterpolator(double startX, double startY, double endX, double endY) {
